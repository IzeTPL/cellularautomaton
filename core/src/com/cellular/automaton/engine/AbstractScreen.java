...
public abstract class AbstractScreen implements Screen {
    ...
    protected AbstractApplication abstractApplication;
    ...
    public AbstractScreen(AbstractApplication abstractApplication) {
        ...
        stage = new Stage(uiViewport, this.abstractApplication.getSpriteBatch());
    ...
    public void render(float delta) {
        ...
        uiViewport.apply();
        abstractApplication.getSpriteBatch().setProjectionMatrix(uiCamera.combined);
        stage.act();
        stage.draw();
        ...
        cellViewport.apply();
        abstractApplication.getSpriteBatch().setProjectionMatrix(cellCamera.combined);
